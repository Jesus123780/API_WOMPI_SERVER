...
exports.LogDanger = exports.LogWarning = exports.LogInfo = exports.LogSuccess = exports.ResponseService = void 0;
const enum_ = __importStar(require("./enum"));
function ResponseService(status, code, message, data) {
